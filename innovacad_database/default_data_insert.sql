...
values ('74a05d40-8e0d-4b52-9537-eb41dcb61100', 'f51d8cb3-a446-4b24-912e-504b9bcf0a61', 'PAL', '0525', 'ongoing',
        UNIX_TIMESTAMP(NOW()),
        UNIX_TIMESTAMP(DATE_ADD(NOW(), INTERVAL 1 YEAR))),
       ('14100964-b06f-4423-b57f-0b545e3dc802', '2d2bf12c-2955-4cb8-8cac-1fdd4f464839', 'CAS', '0926', 'ongoing',
        UNIX_TIMESTAMP(NOW()),
        UNIX_TIMESTAMP(DATE_ADD(NOW(), INTERVAL 1 YEAR)));
...
insert into schedules (schedule_id, class_id, module_id, trainer_id, room_id, online, start_date_timestamp,
                       end_date_timestamp)
values ('057e65f7-81ba-4964-8420-593e16a59bac', '74a05d40-8e0d-4b52-9537-eb41dcb61100',
       ...
       ('e18e6971-c305-46db-8661-49223d7322a0', '74a05d40-8e0d-4b52-9537-eb41dcb61100',
...
values ('c997addf-169b-4832-8219-c1d114c55c3f', '60dcc0e4-7935-4472-8c9d-0f739b1ce68e', UNIX_TIMESTAMP(NOW()),
        UNIX_TIMESTAMP(DATE_ADD(NOW(), INTERVAL 10 HOUR))),
