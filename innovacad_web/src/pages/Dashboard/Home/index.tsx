        ...
        {(data) => (
          <>
            <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <StatCard
                title={t("dashboard.overview.finished_classes")}
                value={data().total_finished_classes}
                icon="CheckCircle"
                color="success"
              />
              <StatCard
                title={t("dashboard.overview.ongoing_classes")}
                value={data().total_ongoing_classes}
                icon="Clock"
                color="info"
              />
              <StatCard
                title={t("dashboard.overview.active_trainees")}
              ...
              <section class="card bg-base-100 shadow border border-base-200">
                <div class="card-body">
                  <h3 class="card-title text-sm uppercase opacity-70 mb-4">
                    <Icon name="ChartPie" size={18} />{" "}
                    {t("dashboard.overview.courses_per_area")}
                  </h3>
                        ...
                        <div class="w-full">
                          <div class="flex justify-between mb-1">
                            ...
                            <span class="text-sm opacity-70">
                              ...
                              {t("dashboard.overview.course_plural")}
                            </span>
                          </div>
                          <progress
                ...
                <div class="card-body p-0">
                  <div class="p-6 pb-2">
                    <h3 class="card-title text-sm uppercase opacity-70">
                      ...
                      {t("dashboard.overview.top_trainers")}
                    </h3>
                  </div>
