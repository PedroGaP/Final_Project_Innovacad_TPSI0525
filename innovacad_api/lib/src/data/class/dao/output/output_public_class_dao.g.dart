...
part of 'output_public_class_dao.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

OutputPublicClassDao _$OutputPublicClassDaoFromJson(
  ...
  modules: OutputPublicClassDao.convertModules(
    json['modules'] as List<OutputPublicClassModuleDao>,
  ),
  courseIdentifier: json['course_identifier'] as String,
);

Map<String, dynamic> _$OutputPublicClassDaoToJson(
  OutputPublicClassDao instance,
) => <String, dynamic>{
