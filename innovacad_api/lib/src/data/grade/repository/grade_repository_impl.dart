    ...
    try {
      ...
      final items = results.map((row) {
        return OutputGradeDao(
          ...
          grade: row["grade"] is num
              ? (row["grade"] as num).toDouble()
              : double.parse(row["grade"].toString()),
  ...
  Future<Result<OutputGradeDao>> getById(String id) async {
    ...
    try {
      ...
      final dao = OutputGradeDao(
        ...
        grade: result["grade"] is num
            ? (result["grade"] as num).toDouble()
            : double.parse(result["grade"].toString()),
    ...
    try {
      ...
      return Result.success(
        OutputGradeDao(
          ...
          grade: created["grade"] is num
              ? (created["grade"] as num).toDouble()
              : double.parse(created["grade"].toString()),
