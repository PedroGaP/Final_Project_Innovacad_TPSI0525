        ...
        AnimatedVisibility(
            ...
            Column(
                ...
                if (course.coursesModules.isNotEmpty()) {
                    ...
                    Text(
                        text = "Modules (${course.coursesModules.size}):",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                    Spacer(modifier = Modifier.height(4.dp))
                    course.coursesModules.sortedBy { it.sequenceId ?: "" }.forEach { module ->
                        Column(
                            ...
                            InfoRow(
                                label = "Sequence",
                                value = module.sequenceId ?: "N/A"
                            )
                            if (module != course.coursesModules.last()) {
                                Spacer(modifier = Modifier.height(8.dp))
                            }
                        }
                    }
